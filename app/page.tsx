...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section id="inicio" className="min-h-screen flex items-center pt-20 bakery-gradient text-white relative overflow-hidden">
        <div className="container mx-auto px-4 py-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p
                className="text-xl md:text-2xl opacity-90 leading-relaxed max-w-2xl"
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button
                  size="lg"
                  className="bg-white text-primary hover:bg-white/90 px-8 py-6 rounded-full font-semibold transition-all duration-300 hover:scale-105 hover:-translate-y-1 shadow-lg"
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-white hover:bg-white hover:text-primary px-8 py-6 rounded-full font-semibold transition-all duration-300 hover:scale-105 bg-transparent shadow-lg"
                  style={{ fontFamily: "var(--font-poppins)" }}
                  asChild
                >
            ...
            <div className="relative lg:block hidden">
              <img
                ...
                className="rounded-2xl shadow-2xl w-full h-auto transform hover:rotate-2 transition-transform duration-500"
                width={600}
                height={500}
                loading="eager"
              />
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-primary/20 rounded-full blur-2xl animate-pulse"></div>
              <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-secondary/20 rounded-full blur-2xl animate-pulse"></div>
            </div>
          </div>
        </div>
