...
export const metadata: Metadata = {
  ...
  keywords: "catering Loja, eventos Loja, catering para bodas, servicio de catering, fiestas, La Viña Dulce",
  openGraph: {
    title: "La Viña Dulce - Catering para Eventos",
    description: "Servicio de catering profesional para bodas, cumpleaños y eventos corporativos en Loja. Menús personalizados, postres exquisitos y atención de primera.",
    images: [
  ...
  const categories = [
    {
      ...
      images: [
        { src: "/images/catering-matrimonio-1.webp", alt: "Catering para Matrimonios 1" },
        { src: "/images/catering-matrimonio-2.webp", alt: "Catering para Matrimonios 2" },
        { src: "/images/catering-matrimonio-3.webp", alt: "Catering para Matrimonios 3" },
      ],
    },
    {
      id: "catering-cumple",
      ...
      images: [
        { src: "/images/cumpleanos-1.webp", alt: "Catering para Cumpleaños 1" },
        { src: "/images/cumpleanos-2.webp", alt: "Catering para Cumpleaños 2" },
        { src: "/images/cumpleanos-3.webp", alt: "Catering para Cumpleaños 3" },
      ],
    },
    {
      ...
      images: [
        { src: "/images/empresarial-1.webp", alt: "Catering Empresarial 1" },
        { src: "/images/empresarial-2.webp", alt: "Catering Empresarial 2" },
        { src: "/images/empresarial-3.webp", alt: "Catering Empresarial 3" },
      ],
    },
    {
      id: "mesa-dulce",
      ...
      images: [
        { src: "/images/mesa-dulce-1.webp", alt: "Mesa Dulce y Postres 1" },
        { src: "/images/mesa-dulce-2.webp", alt: "Mesa Dulce y Postres 2" },
        { src: "/images/mesa-dulce-3.webp", alt: "Mesa Dulce y Postres 3" },
      ],
    },
    {
      id: "coffee-break",
      ...
      images: [
        { src: "/images/coffee-break-1.webp", alt: "Coffee Break 1" },
        { src: "/images/coffee-break-2.webp", alt: "Coffee Break 2" },
        { src: "/images/coffee-break-3.webp", alt: "Coffee Break 3" },
      ],
    },
  ]
